...
public class MenuScene{
    ...
    public MenuScene(Stage stage) {
        ...
        btnStartGame.setOnAction(e->{
            LevelOneScene levelOneScene = new LevelOneScene(stage, scene);
            stage.setScene(levelOneScene.getScene());
        });

        //LEVELS BUTTON
        btnLevels.setOnAction(e->{
            LevelsScene levelsScene = new LevelsScene(stage, scene);
            stage.setScene(levelsScene.getScene());
        });
