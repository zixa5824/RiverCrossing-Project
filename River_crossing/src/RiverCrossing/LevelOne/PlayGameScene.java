...
public class PlayGameScene{
    ...
    public PlayGameScene(Stage stage, Scene menuScene) throws IOException {
        ...
        exitBtn.setPrefWidth(51);
        exitBtn.setLayoutY(96);
        exitBtn.setLayoutX(32);
        ...
        //------
        Pane pane = new Pane();
        pane.getChildren().addAll(bGIv, raftIv,sailBtn, lf, cab, lg, lw, rf, rCab, rg, rw, slf, scab, slg, slw, srf, srCab, srg, srw, rectangle, instructions, label, resetBtn, exitBtn);
